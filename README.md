...
Traction control works by monitoring the acceleration of the wheel and removing power when the acceleration exceeds normal limits. Traction control is based on 15s hypercore with 150lb rider which yielded an appropriate traction limit of 35 erpm per code cycle averaged over 10 code cycles. Higher powered configurations may be able to out accelerate this limit when surging at low erpm. If so, you can send your debug information to the email above and I can adjust the limits as necessary.
